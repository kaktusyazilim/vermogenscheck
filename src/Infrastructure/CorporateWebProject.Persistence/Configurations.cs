    ...
    public static class Configurations
    {
        public static string ConnectionString
        {
            get
            {
                ...
                return "Server=mssql.kaktusdns.com;Database=EslAcademyCorporate2024;User ID=kaktusadmin;Password=Ynyhqmdek35;Max Pool Size=200;Connect Timeout=30;Encrypt=True;TrustServerCertificate=True;"
;
