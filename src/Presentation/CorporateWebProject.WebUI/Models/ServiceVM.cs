...
namespace CorporateWebProject.WebUI.Models
{
    public class ServiceVM : IServiceVM
    {
        ...
        public bool IsFooterActive { get; set; } = true;
        ...
        public List<Exchanges> ExchangesList { get; set; }
        public Exchanges Exchanges { get; set; }


        public ContactCategories ContactCategories { get; set; }
        public List<ContactCategories> ContactCategoriesList { get; set; }
